...
<body>
                    ...
                    @if (Session::has('success'))
                        <div class=" w-50 alert alert-success text-center">
    ...
    <div class="tab">
     <h1 style="text-align: center;">Biller Details </h1><hr>
  ...
  <div class="tab">
    <h1 style="text-align: center;">Biller Account</h1><hr>
...
$('#billaccount').change(function(){
    var selected = $('#billaccount').val();
    
    if (selected == "rx") {

        $('input#inv').remove();
        $('input#rx').remove();
        $('.billing').append('<p><input placeholder="RX#" id="rx" name="RX"></p>');
        
    }
    else if(selected == "inv"){
        $('input#inv').remove();
        $('input#rx').remove();
        $('.billing').append('<p><input placeholder="Invoice#" id="inv" name="Invoice"></p>');  
